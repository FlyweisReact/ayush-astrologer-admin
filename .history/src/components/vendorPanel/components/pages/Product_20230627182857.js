  ...
  const fetchHandler = async () => {
    try {
      const { data } = await axios.get(
        "https://ayush-astro-backend.vercel.app/product/getProduct"
      );
      setData(data);
    } catch (err) {
      console.log(err);
    ...
    const postDetail = async (e) => {
      ...
      try {
        const data = await axios.post(
          "https://ayush-astro-backend.vercel.app/product/addProduct",
          {
            link : url,
            desc,
            price,
  ...
  const deletePro = async (id) => {
    try {
      const data = await axios.delete(
        `https://ayush-astro-backend.vercel.app/product/deleteProduct/${id}`
      );
